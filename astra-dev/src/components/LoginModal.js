      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-zinc-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <Dialog.Title
                  as="h3"
                  className="text-center text-xl font-bold leading-6 text-gray-100"
                >
                  Log In - Astra
                </Dialog.Title>
                ...
                <div className=" flex flex-col my-4">
                  ...
                  />
                  <button
                    className="w-40 border text-sm font-medium px-4 py-2 mt-2 rounded-md bg-black hover:bg-zinc-900"
